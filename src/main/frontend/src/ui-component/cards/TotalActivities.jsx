...
export default function TotalActivities({ isLoading, total, icon, label }) {
...
TotalActivities.propTypes = { isLoading: PropTypes.bool, total: PropTypes.number, icon: PropTypes.node, label: PropTypes.string };
