...
export default function DisplayUserDialog({ open, setOpen, data }) {
            ...
            >
                ...
                <DialogContent dividers>
                    <Grid container spacing={2}>
                        ...
                        {data?.personnel_assignateur?.nom_personnel && <Grid size={6}>
                            <TextField label="Nom Assignateur" value={data?.personnel_assignateur?.nom_personnel} fullWidth />
                        </Grid>}
                        {data?.personnel_en_charge?.nom_personnel && <Grid size={6}>
                            <TextField label="Assigné à" value={data?.personnel_en_charge?.nom_personnel} fullWidth />
                        </Grid>}
                        <Grid size={6}>
