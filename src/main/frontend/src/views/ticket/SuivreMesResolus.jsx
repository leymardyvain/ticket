...
import { getSuivi_Ticket_Superviseur_en_cours_assignation, getSuivi_Ticket_Superviseur_en_cours_resolution, getSuivi_Ticket_Superviseur_resolu } from "../../api/APIsuiviTicket";
...
export default function SuivreMesResolus() {
  ...
  const fetchDataGetSuiviPersonnel = async () => {
    try {
      const response = await getSuivi_Ticket_Superviseur_resolu(username);
      setListSuiviPersonnel(response.data);
    } catch (error) {
      console.error('Error fetching list personnel by resolu:', error);
    }
  };
  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid size={12}>
        <MainCard title="Liste tickets résolus">
          <TextField
              ...
              <Table aria-label="simple table">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="left">Date résolution</TableCell>
