...
export default function BarChartActiviteAnnuelle({ isLoading, listSeries }) {
  ...
  useEffect(() => {
    setChartOptions((prev) => ({
      ...prev,
      colors: [primary200, primaryDark, warningDark, secondaryLight, secondaryMain],
      xaxis: {
        ...prev.xaxis,
      ...
      {isLoading ? (
        ...
        <MainCard>
          <Grid container spacing={gridSpacing}>
              ...
              <Grid container sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
                <Grid>
                  <Grid container direction="column" spacing={1}>
                    <Grid>
                      <Typography variant="h3">Activité année en cours</Typography>
                    </Grid>
                    <Grid>
            ...
            >
              <Chart options={chartOptions} series={listSeries} type="bar" height={480} />
            </Grid>
          </Grid>
        </MainCard>
      )}
...
BarChartActiviteAnnuelle.propTypes = { isLoading: PropTypes.bool };
